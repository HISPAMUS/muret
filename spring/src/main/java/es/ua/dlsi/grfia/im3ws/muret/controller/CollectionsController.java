...
public class CollectionsController {
    ...
    @Transactional
    public Integer moveDocumentToNewSubcollection(@RequestBody MoveDocuments moveDocuments) throws IM3WSException {
    ...
    @Transactional
    public Integer moveDocumentToSubcollection(@RequestBody MoveDocuments moveDocuments) throws IM3WSException {
