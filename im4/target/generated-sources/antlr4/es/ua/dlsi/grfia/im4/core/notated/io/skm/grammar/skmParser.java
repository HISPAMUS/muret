...
public class skmParser extends Parser {
	...
	public static final int
		...
		RULE_noteName = 57, RULE_trebleNotes = 58, RULE_bassNotes = 59, RULE_accidental = 60, 
		RULE_alterationQualifier = 61, RULE_afterNote = 62, RULE_slurStart = 63, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"chord", "beforeNote", "noteName", "trebleNotes", "bassNotes", "accidental", 
			"alterationQualifier", "afterNote", "slurStart", "ligatureStart", "ligatureEnd", 
	...
	public static class NoteContext extends ParserRuleContext {
		...
		public AlterationQualifierContext alterationQualifier() {
			return getRuleContext(AlterationQualifierContext.class,0);
		}
	...
	public final AccidentalContext accidental() throws RecognitionException {
		...
		enterRule(_localctx, 120, RULE_accidental);
		try {
			setState(463);
			_errHandler.sync(this);
	...
	public static class AlterationQualifierContext extends ParserRuleContext {
		...
		public AlterationQualifierContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_alterationQualifier; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof skmParserListener ) ((skmParserListener)listener).enterAlterationQualifier(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof skmParserListener ) ((skmParserListener)listener).exitAlterationQualifier(this);
		}
	}

	public final AlterationQualifierContext alterationQualifier() throws RecognitionException {
		AlterationQualifierContext _localctx = new AlterationQualifierContext(_ctx, getState());
		enterRule(_localctx, 122, RULE_alterationQualifier);
		int _la;
		try {
			setState(473);
			_errHandler.sync(this);
