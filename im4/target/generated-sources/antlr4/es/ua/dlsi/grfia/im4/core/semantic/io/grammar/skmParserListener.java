...
public interface skmParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link skmParser#editorialAccidental}.
	 * @param ctx the parse tree
	 */
	void enterEditorialAccidental(skmParser.EditorialAccidentalContext ctx);
	/**
	 * Exit a parse tree produced by {@link skmParser#editorialAccidental}.
	 * @param ctx the parse tree
	 */
	void exitEditorialAccidental(skmParser.EditorialAccidentalContext ctx);
	/**
