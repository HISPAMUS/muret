...
public class ClefC2 extends Clef {
    ...
    public ClefC2(NotationType notationType) {
        super(notationType, DiatonicPitch.C, 2, 4,
                new PositionInStaff[] {SPACE_3, LINE_2, LINE_4, SPACE_2, SPACE_4, LINE_3, LINE_5},
                new PositionInStaff[] {LINE_5, LINE_3, SPACE_4, SPACE_2, LINE_4, LINE_2, SPACE_3});
    }
    @Override
    public Clef clone() {
    		return new ClefC2(notationType);
    }
