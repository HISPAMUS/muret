...
public class ClefF4QuindicesimaAlta extends Clef {
    ...
    public ClefF4QuindicesimaAlta(NotationType notationType) {
        super(notationType, DiatonicPitch.F, 4, 5, 2,
	...
	//super(DiatonicPitch.F, 4, 5, 3, 2);
    }
    @Override
    public Clef clone() {
    		return new ClefF4QuindicesimaAlta(notationType);
    }
