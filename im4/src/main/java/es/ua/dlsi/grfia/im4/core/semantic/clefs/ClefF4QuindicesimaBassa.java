 ...
 * @author drizo
 */
public class ClefF4QuindicesimaBassa extends Clef {
    
    public ClefF4QuindicesimaBassa(NotationType notationType) {
        super(notationType, DiatonicPitch.F, 4, 1, -2,
    ...
    @Override
    public Clef clone() {
    		return new ClefF4QuindicesimaBassa(notationType);
    }
