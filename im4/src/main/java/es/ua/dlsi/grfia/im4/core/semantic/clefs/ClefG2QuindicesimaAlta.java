...
public class ClefG2QuindicesimaAlta extends Clef {
    ...
    public ClefG2QuindicesimaAlta(NotationType notationType) {
        super(notationType, DiatonicPitch.G, 2, 6, 2,
	...
	//super(DiatonicPitch.G, 2, 6, 5, 4);
    }
    @Override
    public Clef clone() {
    		return new ClefG2QuindicesimaAlta(notationType);
    }
