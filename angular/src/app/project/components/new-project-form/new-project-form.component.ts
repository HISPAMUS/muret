...
export class NewProjectFormComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private sessionDataService: SessionDataService, private projectService: ProjectCrudService, private router: Router, private logger: NGXLogger) {
  }
