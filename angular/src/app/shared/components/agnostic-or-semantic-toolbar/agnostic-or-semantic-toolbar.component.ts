      ...
      switch (this.symbolsFilter) {
        ...
        case 'other':
          return this.svgAgnosticOrSemanticSymbolSet.paths.filter(value => value.agnosticOrSemanticTypeString.includes('defect') ||
            ...
            value.agnosticOrSemanticTypeString.includes('breath') || value.agnosticOrSemanticTypeString.includes('colon') || value.agnosticOrSemanticTypeString.includes('verticalLine') || value.agnosticOrSemanticTypeString.includes('custos'));
        case 'clefsmeters':
